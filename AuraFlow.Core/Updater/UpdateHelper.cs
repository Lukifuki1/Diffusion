...
using AuraFlow.Core.Models.Configs;
...
public class UpdateHelper : IUpdateHelper
{
    ...
    private readonly IAuraCloudAuthApiV2 lykosAuthApi;
    ...
    public const string UpdateFolderName = ".AuraFlowUpdate";
    ...
    public UpdateHelper(
        ...
        IAuraCloudAuthApiV2 lykosAuthApi
    )
    {
        this.logger = logger;

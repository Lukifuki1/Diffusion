...
namespace AuraFlow.Core.Api.PromptGenApi
{
...
namespace AuraFlow.Core.Api.PromptGenApi
{
    ...
    public partial class PromptExpansionRequest
    {
        ...
        public PromptExpansionRequestMode Mode { get; set; } = AuraFlow.Core.Api.PromptGenApi.PromptExpansionRequestMode.Focused;
